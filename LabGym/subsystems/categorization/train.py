...
# ADDEDFRM LabGym.core.categorizer (adapted from Categorizers() class, kinda custom)
class CategorizerTrainer():
    """
    This class implements the categorizer-training workflow.
    """
    # ADDEDFRM LabGym.core.categorizer
    def __init__(self):
        self.extension_image = ('.png','.PNG','.jpeg','.JPEG','.jpg','.JPG','.tiff','.TIFF','.bmp','.BMP') # image formats that LabGym can accept
        self.extension_video = ('.avi','.mpg','.wmv','.mp4','.mkv','.m4v','.mov') # the video formats that LabGym can accept
        self.classnames = None # the behavior category names inthe trained Categorizer
        self.log = []
...
___all___ = ['CategorizerTrainer', 'DatasetFromPath_AA', 'DatasetFromPath']
